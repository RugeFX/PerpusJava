...
public class BukuDAO {
    ...
    public void insertBuku(Buku buku) throws SQLException {
        PreparedStatement pstmt = conn.prepareStatement("INSERT INTO Buku (kodebuku, judulbuku, pengarang, tahunterbit, idkategori, idpenerbit, genre, stokbuku) VALUES (? ,?, ?, ?, ?, ?, ?, ?)");
        ...
        pstmt.setString(7, buku.getGenre());
